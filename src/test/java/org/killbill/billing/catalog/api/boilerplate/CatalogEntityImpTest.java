...
@Test(groups = { "fast" })
public class CatalogEntityImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      CatalogEntityImp a = new CatalogEntityImp.Builder<>().build();
    ...
    {
      CatalogEntityImp a = new CatalogEntityImp.Builder<>().build();
      CatalogEntityImp b = new CatalogEntityImp(a);
    ...
    {
      CatalogEntityImp a = new CatalogEntityImp.Builder<>().build();
      CatalogEntityImp b = new CatalogEntityImp.Builder<>().build();
        ...
        JsonMappingException
    {
      ...
      CatalogEntity b = mapper.readValue(s, CatalogEntity.class);
