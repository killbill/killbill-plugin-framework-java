...
@Test(groups = { "fast" })
public class DurationImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      DurationImp a = new DurationImp.Builder<>().build();
    ...
    {
      DurationImp a = new DurationImp.Builder<>().build();
      DurationImp b = new DurationImp(a);
    ...
    {
      DurationImp a = new DurationImp.Builder<>().build();
      DurationImp b = new DurationImp.Builder<>().build();
        ...
        JsonMappingException
    {
      ...
      Duration b = mapper.readValue(s, Duration.class);
