...
@Test(groups = { "fast" })
public class MigrationPlanImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      MigrationPlanImp a = new MigrationPlanImp.Builder<>().build();
    ...
    {
      MigrationPlanImp a = new MigrationPlanImp.Builder<>().build();
      MigrationPlanImp b = new MigrationPlanImp(a);
    ...
    {
      MigrationPlanImp a = new MigrationPlanImp.Builder<>().build();
      MigrationPlanImp b = new MigrationPlanImp.Builder<>().build();
    ...
    public void callGetters()
    {
      ...
      a.getAllPhases();
      a.getCatalog();
      a.getEffectiveDateForExistingSubscriptions();
      a.getFinalPhase();
      a.getInitialPhaseIterator();
      a.getInitialPhases();
      a.getName();
      a.getPlansAllowedInBundle();
      a.getPrettyName();
      a.getPriceList();
      a.getProduct();
      a.getRecurringBillingMode();
      a.getRecurringBillingPeriod();
    }
    @Test
        ...
        JsonMappingException
    {
      ...
      MigrationPlan b = mapper.readValue(s, MigrationPlan.class);
