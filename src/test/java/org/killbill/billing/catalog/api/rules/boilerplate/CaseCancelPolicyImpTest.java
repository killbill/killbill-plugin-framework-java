...
@Test(groups = { "fast" })
public class CaseCancelPolicyImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      CaseCancelPolicyImp a = new CaseCancelPolicyImp.Builder<>().build();
    ...
    {
      CaseCancelPolicyImp a = new CaseCancelPolicyImp.Builder<>().build();
      CaseCancelPolicyImp b = new CaseCancelPolicyImp(a);
    ...
    {
      CaseCancelPolicyImp a = new CaseCancelPolicyImp.Builder<>().build();
      CaseCancelPolicyImp b = new CaseCancelPolicyImp.Builder<>().build();
        ...
        JsonMappingException
    {
      ...
      CaseCancelPolicy b = mapper.readValue(s, CaseCancelPolicy.class);
