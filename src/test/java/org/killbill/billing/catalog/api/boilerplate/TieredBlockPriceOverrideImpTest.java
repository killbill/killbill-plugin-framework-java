...
@Test(groups = { "fast" })
public class TieredBlockPriceOverrideImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      TieredBlockPriceOverrideImp a = new TieredBlockPriceOverrideImp.Builder<>().build();
    ...
    {
      TieredBlockPriceOverrideImp a = new TieredBlockPriceOverrideImp.Builder<>().build();
      TieredBlockPriceOverrideImp b = new TieredBlockPriceOverrideImp(a);
    ...
    {
      TieredBlockPriceOverrideImp a = new TieredBlockPriceOverrideImp.Builder<>().build();
      TieredBlockPriceOverrideImp b = new TieredBlockPriceOverrideImp.Builder<>().build();
        ...
        JsonMappingException
    {
      ...
      TieredBlockPriceOverride b = mapper.readValue(s, TieredBlockPriceOverride.class);
