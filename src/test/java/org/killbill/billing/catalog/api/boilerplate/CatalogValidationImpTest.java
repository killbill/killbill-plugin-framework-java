...
@Test(groups = { "fast" })
public class CatalogValidationImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      CatalogValidationImp a = new CatalogValidationImp.Builder<>().build();
    ...
    {
      CatalogValidationImp a = new CatalogValidationImp.Builder<>().build();
      CatalogValidationImp b = new CatalogValidationImp(a);
    ...
    {
      CatalogValidationImp a = new CatalogValidationImp.Builder<>().build();
      CatalogValidationImp b = new CatalogValidationImp.Builder<>().build();
        ...
        JsonMappingException
    {
      ...
      CatalogValidation b = mapper.readValue(s, CatalogValidation.class);
