...
@Test(groups = { "fast" })
public class PlanRulesImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      PlanRulesImp a = new PlanRulesImp.Builder<>().build();
    ...
    {
      PlanRulesImp a = new PlanRulesImp.Builder<>().build();
      PlanRulesImp b = new PlanRulesImp(a);
    ...
    {
      PlanRulesImp a = new PlanRulesImp.Builder<>().build();
      PlanRulesImp b = new PlanRulesImp.Builder<>().build();
    ...
    public void callGetters()
    {
      ...
      a.getCaseBillingAlignment();
      a.getCaseCancelPolicy();
      a.getCaseChangePlanAlignment();
      a.getCaseChangePlanPolicy();
      a.getCaseCreateAlignment();
      a.getCasePriceList();
      a.getCatalog();
    }
    @Test
        ...
        JsonMappingException
    {
      ...
      PlanRules b = mapper.readValue(s, PlanRules.class);
