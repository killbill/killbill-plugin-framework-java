...
@Test(groups = { "fast" })
public class PriceListSetImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      PriceListSetImp a = new PriceListSetImp.Builder<>().build();
    ...
    {
      PriceListSetImp a = new PriceListSetImp.Builder<>().build();
      PriceListSetImp b = new PriceListSetImp(a);
    ...
    {
      PriceListSetImp a = new PriceListSetImp.Builder<>().build();
      PriceListSetImp b = new PriceListSetImp.Builder<>().build();
        ...
        JsonMappingException
    {
      ...
      PriceListSet b = mapper.readValue(s, PriceListSet.class);
