...
@Test(groups = { "fast" })
public class CaseChangePlanAlignmentImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      CaseChangePlanAlignmentImp a = new CaseChangePlanAlignmentImp.Builder<>().build();
    ...
    {
      CaseChangePlanAlignmentImp a = new CaseChangePlanAlignmentImp.Builder<>().build();
      CaseChangePlanAlignmentImp b = new CaseChangePlanAlignmentImp(a);
    ...
    {
      CaseChangePlanAlignmentImp a = new CaseChangePlanAlignmentImp.Builder<>().build();
      CaseChangePlanAlignmentImp b = new CaseChangePlanAlignmentImp.Builder<>().build();
        ...
        JsonMappingException
    {
      ...
      CaseChangePlanAlignment b = mapper.readValue(s, CaseChangePlanAlignment.class);
