...
@Test(groups = { "fast" })
public class TieredBlockImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      TieredBlockImp a = new TieredBlockImp.Builder<>().build();
    ...
    {
      TieredBlockImp a = new TieredBlockImp.Builder<>().build();
      TieredBlockImp b = new TieredBlockImp(a);
    ...
    {
      TieredBlockImp a = new TieredBlockImp.Builder<>().build();
      TieredBlockImp b = new TieredBlockImp.Builder<>().build();
        ...
        JsonMappingException
    {
      ...
      TieredBlock b = mapper.readValue(s, TieredBlock.class);
