...
@Test(groups = { "fast" })
public class TierImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      TierImp a = new TierImp.Builder<>().build();
    ...
    {
      TierImp a = new TierImp.Builder<>().build();
      TierImp b = new TierImp.Builder<>().build();
        ...
        JsonMappingException
    {
      ...
      Tier b = mapper.readValue(s, Tier.class);
