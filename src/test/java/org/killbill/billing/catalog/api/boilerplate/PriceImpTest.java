...
@Test(groups = { "fast" })
public class PriceImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      PriceImp a = new PriceImp.Builder<>().build();
    ...
    {
      PriceImp a = new PriceImp.Builder<>().build();
      PriceImp b = new PriceImp.Builder<>().build();
        ...
        JsonMappingException
    {
      ...
      Price b = mapper.readValue(s, Price.class);
