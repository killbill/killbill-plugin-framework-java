...
@Test(groups = { "fast" })
public class CaseBillingAlignmentImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      CaseBillingAlignmentImp a = new CaseBillingAlignmentImp.Builder<>().build();
    ...
    {
      CaseBillingAlignmentImp a = new CaseBillingAlignmentImp.Builder<>().build();
      CaseBillingAlignmentImp b = new CaseBillingAlignmentImp(a);
    ...
    {
      CaseBillingAlignmentImp a = new CaseBillingAlignmentImp.Builder<>().build();
      CaseBillingAlignmentImp b = new CaseBillingAlignmentImp.Builder<>().build();
        ...
        JsonMappingException
    {
      ...
      CaseBillingAlignment b = mapper.readValue(s, CaseBillingAlignment.class);
