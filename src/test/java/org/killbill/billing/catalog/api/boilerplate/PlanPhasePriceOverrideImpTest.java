...
@Test(groups = { "fast" })
public class PlanPhasePriceOverrideImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      PlanPhasePriceOverrideImp a = new PlanPhasePriceOverrideImp.Builder<>().build();
    ...
    {
      PlanPhasePriceOverrideImp a = new PlanPhasePriceOverrideImp.Builder<>().build();
      PlanPhasePriceOverrideImp b = new PlanPhasePriceOverrideImp(a);
    ...
    {
      PlanPhasePriceOverrideImp a = new PlanPhasePriceOverrideImp.Builder<>().build();
      PlanPhasePriceOverrideImp b = new PlanPhasePriceOverrideImp.Builder<>().build();
        ...
        JsonMappingException
    {
      ...
      PlanPhasePriceOverride b = mapper.readValue(s, PlanPhasePriceOverride.class);
