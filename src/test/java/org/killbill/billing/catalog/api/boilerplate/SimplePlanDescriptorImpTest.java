...
@Test(groups = { "fast" })
public class SimplePlanDescriptorImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      SimplePlanDescriptorImp a = new SimplePlanDescriptorImp.Builder<>().build();
    ...
    {
      SimplePlanDescriptorImp a = new SimplePlanDescriptorImp.Builder<>().build();
      SimplePlanDescriptorImp b = new SimplePlanDescriptorImp(a);
    ...
    {
      SimplePlanDescriptorImp a = new SimplePlanDescriptorImp.Builder<>().build();
      SimplePlanDescriptorImp b = new SimplePlanDescriptorImp.Builder<>().build();
        ...
        JsonMappingException
    {
      ...
      SimplePlanDescriptor b = mapper.readValue(s, SimplePlanDescriptor.class);
