...
@Test(groups = { "fast" })
public class CaseChangeImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      CaseChangeImp a = new CaseChangeImp.Builder<>().build();
    ...
    {
      CaseChangeImp a = new CaseChangeImp.Builder<>().build();
      CaseChangeImp b = new CaseChangeImp(a);
    ...
    {
      CaseChangeImp a = new CaseChangeImp.Builder<>().build();
      CaseChangeImp b = new CaseChangeImp.Builder<>().build();
        ...
        JsonMappingException
    {
      ...
      CaseChange b = mapper.readValue(s, CaseChange.class);
