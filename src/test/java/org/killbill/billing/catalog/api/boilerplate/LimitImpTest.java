...
@Test(groups = { "fast" })
public class LimitImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      LimitImp a = new LimitImp.Builder<>().build();
    ...
    {
      LimitImp a = new LimitImp.Builder<>().build();
      LimitImp b = new LimitImp.Builder<>().build();
        ...
        JsonMappingException
    {
      ...
      Limit b = mapper.readValue(s, Limit.class);
