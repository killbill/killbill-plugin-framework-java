...
@Test(groups = { "fast" })
public class InternationalPriceImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      InternationalPriceImp a = new InternationalPriceImp.Builder<>().build();
    ...
    {
      InternationalPriceImp a = new InternationalPriceImp.Builder<>().build();
      InternationalPriceImp b = new InternationalPriceImp(a);
    ...
    {
      InternationalPriceImp a = new InternationalPriceImp.Builder<>().build();
      InternationalPriceImp b = new InternationalPriceImp.Builder<>().build();
        ...
        JsonMappingException
    {
      ...
      InternationalPrice b = mapper.readValue(s, InternationalPrice.class);
