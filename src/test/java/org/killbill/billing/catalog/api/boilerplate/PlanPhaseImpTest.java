...
@Test(groups = { "fast" })
public class PlanPhaseImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      PlanPhaseImp a = new PlanPhaseImp.Builder<>().build();
    ...
    {
      PlanPhaseImp a = new PlanPhaseImp.Builder<>().build();
      PlanPhaseImp b = new PlanPhaseImp(a);
    ...
    {
      PlanPhaseImp a = new PlanPhaseImp.Builder<>().build();
      PlanPhaseImp b = new PlanPhaseImp.Builder<>().build();
        ...
        JsonMappingException
    {
      ...
      PlanPhase b = mapper.readValue(s, PlanPhase.class);
