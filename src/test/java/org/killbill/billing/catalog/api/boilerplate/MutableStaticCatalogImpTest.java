...
@Test(groups = { "fast" })
public class MutableStaticCatalogImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      MutableStaticCatalogImp a = new MutableStaticCatalogImp.Builder<>().build();
    ...
    {
      MutableStaticCatalogImp a = new MutableStaticCatalogImp.Builder<>().build();
      MutableStaticCatalogImp b = new MutableStaticCatalogImp(a);
    ...
    {
      MutableStaticCatalogImp a = new MutableStaticCatalogImp.Builder<>().build();
      MutableStaticCatalogImp b = new MutableStaticCatalogImp.Builder<>().build();
        ...
        JsonMappingException
    {
      ...
      MutableStaticCatalog b = mapper.readValue(s, MutableStaticCatalog.class);
