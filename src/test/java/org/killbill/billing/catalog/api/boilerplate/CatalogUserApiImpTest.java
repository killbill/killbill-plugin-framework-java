...
@Test(groups = { "fast" })
public class CatalogUserApiImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      CatalogUserApiImp a = new CatalogUserApiImp.Builder<>().build();
    ...
    {
      CatalogUserApiImp a = new CatalogUserApiImp.Builder<>().build();
      CatalogUserApiImp b = new CatalogUserApiImp(a);
    ...
    {
      CatalogUserApiImp a = new CatalogUserApiImp.Builder<>().build();
      CatalogUserApiImp b = new CatalogUserApiImp.Builder<>().build();
        ...
        JsonMappingException
    {
      ...
      CatalogUserApi b = mapper.readValue(s, CatalogUserApi.class);
