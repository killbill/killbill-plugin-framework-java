...
@Test(groups = { "fast" })
public class CaseCreateAlignmentImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      CaseCreateAlignmentImp a = new CaseCreateAlignmentImp.Builder<>().build();
    ...
    {
      CaseCreateAlignmentImp a = new CaseCreateAlignmentImp.Builder<>().build();
      CaseCreateAlignmentImp b = new CaseCreateAlignmentImp(a);
    ...
    {
      CaseCreateAlignmentImp a = new CaseCreateAlignmentImp.Builder<>().build();
      CaseCreateAlignmentImp b = new CaseCreateAlignmentImp.Builder<>().build();
        ...
        JsonMappingException
    {
      ...
      CaseCreateAlignment b = mapper.readValue(s, CaseCreateAlignment.class);
