...
@Test(groups = { "fast" })
public class CasePriceListImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      CasePriceListImp a = new CasePriceListImp.Builder<>().build();
    ...
    {
      CasePriceListImp a = new CasePriceListImp.Builder<>().build();
      CasePriceListImp b = new CasePriceListImp(a);
    ...
    {
      CasePriceListImp a = new CasePriceListImp.Builder<>().build();
      CasePriceListImp b = new CasePriceListImp.Builder<>().build();
        ...
        JsonMappingException
    {
      ...
      CasePriceList b = mapper.readValue(s, CasePriceList.class);
