...
@Test(groups = { "fast" })
public class UnitImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      UnitImp a = new UnitImp.Builder<>().build();
    ...
    {
      UnitImp a = new UnitImp.Builder<>().build();
      UnitImp b = new UnitImp.Builder<>().build();
        ...
        JsonMappingException
    {
      ...
      Unit b = mapper.readValue(s, Unit.class);
