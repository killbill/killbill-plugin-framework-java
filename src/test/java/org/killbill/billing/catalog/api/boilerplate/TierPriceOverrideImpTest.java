...
@Test(groups = { "fast" })
public class TierPriceOverrideImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      TierPriceOverrideImp a = new TierPriceOverrideImp.Builder<>().build();
    ...
    {
      TierPriceOverrideImp a = new TierPriceOverrideImp.Builder<>().build();
      TierPriceOverrideImp b = new TierPriceOverrideImp(a);
    ...
    {
      TierPriceOverrideImp a = new TierPriceOverrideImp.Builder<>().build();
      TierPriceOverrideImp b = new TierPriceOverrideImp.Builder<>().build();
    ...
    public void callGetters()
    {
      ...
      a.getTieredBlockPriceOverrides();
    }
    @Test
        ...
        JsonMappingException
    {
      ...
      TierPriceOverride b = mapper.readValue(s, TierPriceOverride.class);
