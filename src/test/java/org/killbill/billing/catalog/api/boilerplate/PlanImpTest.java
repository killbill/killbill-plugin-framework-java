...
@Test(groups = { "fast" })
public class PlanImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      PlanImp a = new PlanImp.Builder<>().build();
    ...
    {
      PlanImp a = new PlanImp.Builder<>().build();
      PlanImp b = new PlanImp.Builder<>().build();
        ...
        JsonMappingException
    {
      ...
      Plan b = mapper.readValue(s, Plan.class);
