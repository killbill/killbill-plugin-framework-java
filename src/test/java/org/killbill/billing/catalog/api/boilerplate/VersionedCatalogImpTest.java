...
@Test(groups = { "fast" })
public class VersionedCatalogImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      VersionedCatalogImp a = new VersionedCatalogImp.Builder<>().build();
    ...
    {
      VersionedCatalogImp a = new VersionedCatalogImp.Builder<>().build();
      VersionedCatalogImp b = new VersionedCatalogImp(a);
    ...
    {
      VersionedCatalogImp a = new VersionedCatalogImp.Builder<>().build();
      VersionedCatalogImp b = new VersionedCatalogImp.Builder<>().build();
        ...
        JsonMappingException
    {
      ...
      VersionedCatalog b = mapper.readValue(s, VersionedCatalog.class);
