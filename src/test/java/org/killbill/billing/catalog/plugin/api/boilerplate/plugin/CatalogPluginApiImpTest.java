...
@Test(groups = { "fast" })
public class CatalogPluginApiImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      CatalogPluginApiImp a = new CatalogPluginApiImp.Builder<>().build();
    ...
    {
      CatalogPluginApiImp a = new CatalogPluginApiImp.Builder<>().build();
      CatalogPluginApiImp b = new CatalogPluginApiImp(a);
    ...
    {
      CatalogPluginApiImp a = new CatalogPluginApiImp.Builder<>().build();
      CatalogPluginApiImp b = new CatalogPluginApiImp.Builder<>().build();
        ...
        JsonMappingException
    {
      ...
      CatalogPluginApi b = mapper.readValue(s, CatalogPluginApi.class);
