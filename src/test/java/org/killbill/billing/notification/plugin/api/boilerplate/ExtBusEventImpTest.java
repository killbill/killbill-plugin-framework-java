...
@Test(groups = { "fast" })
public class ExtBusEventImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      ExtBusEventImp a = new ExtBusEventImp.Builder<>().build();
    ...
    {
      ExtBusEventImp a = new ExtBusEventImp.Builder<>().build();
      ExtBusEventImp b = new ExtBusEventImp(a);
    ...
    {
      ExtBusEventImp a = new ExtBusEventImp.Builder<>().build();
      ExtBusEventImp b = new ExtBusEventImp.Builder<>().build();
        ...
        JsonMappingException
    {
      ...
      ExtBusEvent b = mapper.readValue(s, ExtBusEvent.class);
