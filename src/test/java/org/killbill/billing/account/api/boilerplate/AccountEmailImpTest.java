...
@Test(groups = { "fast" })
public class AccountEmailImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      AccountEmailImp a = new AccountEmailImp.Builder<>().build();
    ...
    {
      AccountEmailImp a = new AccountEmailImp.Builder<>().build();
      AccountEmailImp b = new AccountEmailImp(a);
    ...
    {
      AccountEmailImp a = new AccountEmailImp.Builder<>().build();
      AccountEmailImp b = new AccountEmailImp.Builder<>().build();
        ...
        JsonMappingException
    {
      ...
      AccountEmail b = mapper.readValue(s, AccountEmail.class);
