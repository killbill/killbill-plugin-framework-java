...
@Test(groups = { "fast" })
public class ImmutableAccountDataImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      ImmutableAccountDataImp a = new ImmutableAccountDataImp.Builder<>().build();
    ...
    {
      ImmutableAccountDataImp a = new ImmutableAccountDataImp.Builder<>().build();
      ImmutableAccountDataImp b = new ImmutableAccountDataImp(a);
    ...
    {
      ImmutableAccountDataImp a = new ImmutableAccountDataImp.Builder<>().build();
      ImmutableAccountDataImp b = new ImmutableAccountDataImp.Builder<>().build();
        ...
        JsonMappingException
    {
      ...
      ImmutableAccountData b = mapper.readValue(s, ImmutableAccountData.class);
