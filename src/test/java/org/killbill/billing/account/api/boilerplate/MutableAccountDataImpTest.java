...
@Test(groups = { "fast" })
public class MutableAccountDataImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      MutableAccountDataImp a = new MutableAccountDataImp.Builder<>().build();
    ...
    {
      MutableAccountDataImp a = new MutableAccountDataImp.Builder<>().build();
      MutableAccountDataImp b = new MutableAccountDataImp(a);
    ...
    {
      MutableAccountDataImp a = new MutableAccountDataImp.Builder<>().build();
      MutableAccountDataImp b = new MutableAccountDataImp.Builder<>().build();
        ...
        JsonMappingException
    {
      ...
      MutableAccountData b = mapper.readValue(s, MutableAccountData.class);
