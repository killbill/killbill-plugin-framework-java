...
@Test(groups = { "fast" })
public class EntitlementApiImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      EntitlementApiImp a = new EntitlementApiImp.Builder<>().build();
    ...
    {
      EntitlementApiImp a = new EntitlementApiImp.Builder<>().build();
      EntitlementApiImp b = new EntitlementApiImp(a);
    ...
    {
      EntitlementApiImp a = new EntitlementApiImp.Builder<>().build();
      EntitlementApiImp b = new EntitlementApiImp.Builder<>().build();
        ...
        JsonMappingException
    {
      ...
      EntitlementApi b = mapper.readValue(s, EntitlementApi.class);
