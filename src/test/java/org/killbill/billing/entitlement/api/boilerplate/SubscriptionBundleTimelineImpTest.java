...
@Test(groups = { "fast" })
public class SubscriptionBundleTimelineImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      SubscriptionBundleTimelineImp a = new SubscriptionBundleTimelineImp.Builder<>().build();
    ...
    {
      SubscriptionBundleTimelineImp a = new SubscriptionBundleTimelineImp.Builder<>().build();
      SubscriptionBundleTimelineImp b = new SubscriptionBundleTimelineImp(a);
    ...
    {
      SubscriptionBundleTimelineImp a = new SubscriptionBundleTimelineImp.Builder<>().build();
      SubscriptionBundleTimelineImp b = new SubscriptionBundleTimelineImp.Builder<>().build();
        ...
        JsonMappingException
    {
      ...
      SubscriptionBundleTimeline b = mapper.readValue(s, SubscriptionBundleTimeline.class);
