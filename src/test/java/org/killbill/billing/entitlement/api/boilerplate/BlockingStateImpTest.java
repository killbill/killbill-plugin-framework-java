...
@Test(groups = { "fast" })
public class BlockingStateImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      BlockingStateImp a = new BlockingStateImp.Builder<>().build();
    ...
    {
      BlockingStateImp a = new BlockingStateImp.Builder<>().build();
      BlockingStateImp b = new BlockingStateImp(a);
    ...
    {
      BlockingStateImp a = new BlockingStateImp.Builder<>().build();
      BlockingStateImp b = new BlockingStateImp.Builder<>().build();
        ...
        JsonMappingException
    {
      ...
      BlockingState b = mapper.readValue(s, BlockingState.class);
