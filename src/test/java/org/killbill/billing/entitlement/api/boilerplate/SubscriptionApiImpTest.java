...
@Test(groups = { "fast" })
public class SubscriptionApiImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      SubscriptionApiImp a = new SubscriptionApiImp.Builder<>().build();
    ...
    {
      SubscriptionApiImp a = new SubscriptionApiImp.Builder<>().build();
      SubscriptionApiImp b = new SubscriptionApiImp(a);
    ...
    {
      SubscriptionApiImp a = new SubscriptionApiImp.Builder<>().build();
      SubscriptionApiImp b = new SubscriptionApiImp.Builder<>().build();
        ...
        JsonMappingException
    {
      ...
      SubscriptionApi b = mapper.readValue(s, SubscriptionApi.class);
