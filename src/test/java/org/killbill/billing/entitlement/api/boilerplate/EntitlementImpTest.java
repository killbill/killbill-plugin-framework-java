...
@Test(groups = { "fast" })
public class EntitlementImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      EntitlementImp a = new EntitlementImp.Builder<>().build();
    ...
    {
      EntitlementImp a = new EntitlementImp.Builder<>().build();
      EntitlementImp b = new EntitlementImp(a);
    ...
    {
      EntitlementImp a = new EntitlementImp.Builder<>().build();
      EntitlementImp b = new EntitlementImp.Builder<>().build();
        ...
        JsonMappingException
    {
      ...
      Entitlement b = mapper.readValue(s, Entitlement.class);
