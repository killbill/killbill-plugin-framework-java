...
@Test(groups = { "fast" })
public class SubscriptionBundleImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      SubscriptionBundleImp a = new SubscriptionBundleImp.Builder<>().build();
    ...
    {
      SubscriptionBundleImp a = new SubscriptionBundleImp.Builder<>().build();
      SubscriptionBundleImp b = new SubscriptionBundleImp(a);
    ...
    {
      SubscriptionBundleImp a = new SubscriptionBundleImp.Builder<>().build();
      SubscriptionBundleImp b = new SubscriptionBundleImp.Builder<>().build();
        ...
        JsonMappingException
    {
      ...
      SubscriptionBundle b = mapper.readValue(s, SubscriptionBundle.class);
