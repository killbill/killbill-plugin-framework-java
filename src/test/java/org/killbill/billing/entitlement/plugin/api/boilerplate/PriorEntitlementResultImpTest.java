...
@Test(groups = { "fast" })
public class PriorEntitlementResultImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      PriorEntitlementResultImp a = new PriorEntitlementResultImp.Builder<>().build();
    ...
    {
      PriorEntitlementResultImp a = new PriorEntitlementResultImp.Builder<>().build();
      PriorEntitlementResultImp b = new PriorEntitlementResultImp(a);
    ...
    {
      PriorEntitlementResultImp a = new PriorEntitlementResultImp.Builder<>().build();
      PriorEntitlementResultImp b = new PriorEntitlementResultImp.Builder<>().build();
    ...
    public void callGetters()
    {
      ...
      a.getAdjustedBaseEntitlementWithAddOnsSpecifiers();
      a.getAdjustedBillingActionPolicy();
        ...
        JsonMappingException
    {
      ...
      PriorEntitlementResult b = mapper.readValue(s, PriorEntitlementResult.class);
