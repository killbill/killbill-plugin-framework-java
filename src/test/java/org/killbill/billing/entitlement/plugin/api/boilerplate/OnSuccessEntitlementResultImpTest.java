...
@Test(groups = { "fast" })
public class OnSuccessEntitlementResultImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      OnSuccessEntitlementResultImp a = new OnSuccessEntitlementResultImp.Builder<>().build();
    ...
    {
      OnSuccessEntitlementResultImp a = new OnSuccessEntitlementResultImp.Builder<>().build();
      OnSuccessEntitlementResultImp b = new OnSuccessEntitlementResultImp(a);
    ...
    {
      OnSuccessEntitlementResultImp a = new OnSuccessEntitlementResultImp.Builder<>().build();
      OnSuccessEntitlementResultImp b = new OnSuccessEntitlementResultImp.Builder<>().build();
        ...
        JsonMappingException
    {
      ...
      OnSuccessEntitlementResult b = mapper.readValue(s, OnSuccessEntitlementResult.class);
