...
@Test(groups = { "fast" })
public class EntitlementContextImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      EntitlementContextImp a = new EntitlementContextImp.Builder<>().build();
    ...
    {
      EntitlementContextImp a = new EntitlementContextImp.Builder<>().build();
      EntitlementContextImp b = new EntitlementContextImp(a);
    ...
    {
      EntitlementContextImp a = new EntitlementContextImp.Builder<>().build();
      EntitlementContextImp b = new EntitlementContextImp.Builder<>().build();
    ...
    public void callGetters()
    {
      ...
      a.getAccountId();
      a.getBaseEntitlementWithAddOnsSpecifiers();
      a.getBillingActionPolicy();
      a.getCallOrigin();
      a.getComments();
      a.getCreatedDate();
      a.getDestinationAccountId();
      a.getOperationType();
        ...
        JsonMappingException
    {
      ...
      EntitlementContext b = mapper.readValue(s, EntitlementContext.class);
