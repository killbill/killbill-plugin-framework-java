...
@Test(groups = { "fast" })
public class HostedPaymentPageFormDescriptorImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      HostedPaymentPageFormDescriptorImp a = new HostedPaymentPageFormDescriptorImp.Builder<>().build();
    ...
    {
      HostedPaymentPageFormDescriptorImp a = new HostedPaymentPageFormDescriptorImp.Builder<>().build();
      HostedPaymentPageFormDescriptorImp b = new HostedPaymentPageFormDescriptorImp(a);
    ...
    {
      HostedPaymentPageFormDescriptorImp a = new HostedPaymentPageFormDescriptorImp.Builder<>().build();
      HostedPaymentPageFormDescriptorImp b = new HostedPaymentPageFormDescriptorImp.Builder<>().build();
        ...
        JsonMappingException
    {
      ...
      HostedPaymentPageFormDescriptor b = mapper.readValue(s, HostedPaymentPageFormDescriptor.class);
