...
@Test(groups = { "fast" })
public class PaymentPluginApiImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      PaymentPluginApiImp a = new PaymentPluginApiImp.Builder<>().build();
    ...
    {
      PaymentPluginApiImp a = new PaymentPluginApiImp.Builder<>().build();
      PaymentPluginApiImp b = new PaymentPluginApiImp(a);
    ...
    {
      PaymentPluginApiImp a = new PaymentPluginApiImp.Builder<>().build();
      PaymentPluginApiImp b = new PaymentPluginApiImp.Builder<>().build();
        ...
        JsonMappingException
    {
      ...
      PaymentPluginApi b = mapper.readValue(s, PaymentPluginApi.class);
