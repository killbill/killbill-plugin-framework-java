...
@Test(groups = { "fast" })
public class PaymentMethodInfoPluginImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      PaymentMethodInfoPluginImp a = new PaymentMethodInfoPluginImp.Builder<>().build();
    ...
    {
      PaymentMethodInfoPluginImp a = new PaymentMethodInfoPluginImp.Builder<>().build();
      PaymentMethodInfoPluginImp b = new PaymentMethodInfoPluginImp(a);
    ...
    {
      PaymentMethodInfoPluginImp a = new PaymentMethodInfoPluginImp.Builder<>().build();
      PaymentMethodInfoPluginImp b = new PaymentMethodInfoPluginImp.Builder<>().build();
        ...
        JsonMappingException
    {
      ...
      PaymentMethodInfoPlugin b = mapper.readValue(s, PaymentMethodInfoPlugin.class);
