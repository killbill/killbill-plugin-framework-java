...
@Test(groups = { "fast" })
public class PaymentOptionsImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      PaymentOptionsImp a = new PaymentOptionsImp.Builder<>().build();
    ...
    {
      PaymentOptionsImp a = new PaymentOptionsImp.Builder<>().build();
      PaymentOptionsImp b = new PaymentOptionsImp(a);
    ...
    {
      PaymentOptionsImp a = new PaymentOptionsImp.Builder<>().build();
      PaymentOptionsImp b = new PaymentOptionsImp.Builder<>().build();
    ...
    public void callGetters()
    {
      ...
      a.getPaymentControlPluginNames();
    }
    @Test
        ...
        JsonMappingException
    {
      ...
      PaymentOptions b = mapper.readValue(s, PaymentOptions.class);
