...
@Test(groups = { "fast" })
public class PaymentMethodImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      PaymentMethodImp a = new PaymentMethodImp.Builder<>().build();
    ...
    {
      PaymentMethodImp a = new PaymentMethodImp.Builder<>().build();
      PaymentMethodImp b = new PaymentMethodImp(a);
    ...
    {
      PaymentMethodImp a = new PaymentMethodImp.Builder<>().build();
      PaymentMethodImp b = new PaymentMethodImp.Builder<>().build();
        ...
        JsonMappingException
    {
      ...
      PaymentMethod b = mapper.readValue(s, PaymentMethod.class);
