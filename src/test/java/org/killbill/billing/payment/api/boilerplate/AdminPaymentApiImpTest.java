...
@Test(groups = { "fast" })
public class AdminPaymentApiImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      AdminPaymentApiImp a = new AdminPaymentApiImp.Builder<>().build();
    ...
    {
      AdminPaymentApiImp a = new AdminPaymentApiImp.Builder<>().build();
      AdminPaymentApiImp b = new AdminPaymentApiImp(a);
    ...
    {
      AdminPaymentApiImp a = new AdminPaymentApiImp.Builder<>().build();
      AdminPaymentApiImp b = new AdminPaymentApiImp.Builder<>().build();
        ...
        JsonMappingException
    {
      ...
      AdminPaymentApi b = mapper.readValue(s, AdminPaymentApi.class);
