...
public class PaymentImpTest {
    ...
    {
      PaymentImp a = new PaymentImp.Builder<>().build();
    ...
    {
      PaymentImp a = new PaymentImp.Builder<>().build();
      PaymentImp b = new PaymentImp.Builder<>().build();
    ...
    public void callGetters()
    {
      ...
      a.getExternalKey();
      a.getId();
      a.getPaymentAttempts();
      a.getPaymentMethodId();
      a.getPaymentNumber();
      a.getPurchasedAmount();
      a.getRefundedAmount();
      a.getTransactions();
      a.getUpdatedDate();
    }
        ...
        JsonMappingException
    {
      ...
      Payment b = mapper.readValue(s, Payment.class);
