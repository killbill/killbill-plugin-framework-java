...
@Test(groups = { "fast" })
public class InvoicePaymentApiImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      InvoicePaymentApiImp a = new InvoicePaymentApiImp.Builder<>().build();
    ...
    {
      InvoicePaymentApiImp a = new InvoicePaymentApiImp.Builder<>().build();
      InvoicePaymentApiImp b = new InvoicePaymentApiImp(a);
    ...
    {
      InvoicePaymentApiImp a = new InvoicePaymentApiImp.Builder<>().build();
      InvoicePaymentApiImp b = new InvoicePaymentApiImp.Builder<>().build();
        ...
        JsonMappingException
    {
      ...
      InvoicePaymentApi b = mapper.readValue(s, InvoicePaymentApi.class);
