...
@Test(groups = { "fast" })
public class PaymentGatewayApiImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      PaymentGatewayApiImp a = new PaymentGatewayApiImp.Builder<>().build();
    ...
    {
      PaymentGatewayApiImp a = new PaymentGatewayApiImp.Builder<>().build();
      PaymentGatewayApiImp b = new PaymentGatewayApiImp(a);
    ...
    {
      PaymentGatewayApiImp a = new PaymentGatewayApiImp.Builder<>().build();
      PaymentGatewayApiImp b = new PaymentGatewayApiImp.Builder<>().build();
        ...
        JsonMappingException
    {
      ...
      PaymentGatewayApi b = mapper.readValue(s, PaymentGatewayApi.class);
