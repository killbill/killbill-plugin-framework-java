...
@Test(groups = { "fast" })
public class RateImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      RateImp a = new RateImp.Builder<>().build();
    ...
    {
      RateImp a = new RateImp.Builder<>().build();
      RateImp b = new RateImp.Builder<>().build();
        ...
        JsonMappingException
    {
      ...
      Rate b = mapper.readValue(s, Rate.class);
