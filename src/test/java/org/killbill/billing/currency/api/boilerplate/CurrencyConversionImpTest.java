...
@Test(groups = { "fast" })
public class CurrencyConversionImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      CurrencyConversionImp a = new CurrencyConversionImp.Builder<>().build();
    ...
    {
      CurrencyConversionImp a = new CurrencyConversionImp.Builder<>().build();
      CurrencyConversionImp b = new CurrencyConversionImp(a);
    ...
    {
      CurrencyConversionImp a = new CurrencyConversionImp.Builder<>().build();
      CurrencyConversionImp b = new CurrencyConversionImp.Builder<>().build();
        ...
        JsonMappingException
    {
      ...
      CurrencyConversion b = mapper.readValue(s, CurrencyConversion.class);
