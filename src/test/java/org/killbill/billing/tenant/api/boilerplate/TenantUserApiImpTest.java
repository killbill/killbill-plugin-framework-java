...
@Test(groups = { "fast" })
public class TenantUserApiImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      TenantUserApiImp a = new TenantUserApiImp.Builder<>().build();
    ...
    {
      TenantUserApiImp a = new TenantUserApiImp.Builder<>().build();
      TenantUserApiImp b = new TenantUserApiImp(a);
    ...
    {
      TenantUserApiImp a = new TenantUserApiImp.Builder<>().build();
      TenantUserApiImp b = new TenantUserApiImp.Builder<>().build();
        ...
        JsonMappingException
    {
      ...
      TenantUserApi b = mapper.readValue(s, TenantUserApi.class);
