...
@Test(groups = { "fast" })
public class TenantKVImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      TenantKVImp a = new TenantKVImp.Builder<>().build();
    ...
    {
      TenantKVImp a = new TenantKVImp.Builder<>().build();
      TenantKVImp b = new TenantKVImp(a);
    ...
    {
      TenantKVImp a = new TenantKVImp.Builder<>().build();
      TenantKVImp b = new TenantKVImp.Builder<>().build();
        ...
        JsonMappingException
    {
      ...
      TenantKV b = mapper.readValue(s, TenantKV.class);
