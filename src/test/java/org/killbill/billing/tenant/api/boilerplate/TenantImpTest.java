...
@Test(groups = { "fast" })
public class TenantImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      TenantImp a = new TenantImp.Builder<>().build();
    ...
    {
      TenantImp a = new TenantImp.Builder<>().build();
      TenantImp b = new TenantImp.Builder<>().build();
        ...
        JsonMappingException
    {
      ...
      Tenant b = mapper.readValue(s, Tenant.class);
