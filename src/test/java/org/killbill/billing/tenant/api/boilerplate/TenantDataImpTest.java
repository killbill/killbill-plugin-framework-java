...
@Test(groups = { "fast" })
public class TenantDataImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      TenantDataImp a = new TenantDataImp.Builder<>().build();
    ...
    {
      TenantDataImp a = new TenantDataImp.Builder<>().build();
      TenantDataImp b = new TenantDataImp(a);
    ...
    {
      TenantDataImp a = new TenantDataImp.Builder<>().build();
      TenantDataImp b = new TenantDataImp.Builder<>().build();
        ...
        JsonMappingException
    {
      ...
      TenantData b = mapper.readValue(s, TenantData.class);
