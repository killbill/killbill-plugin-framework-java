...
@Test(groups = { "fast" })
public class AuditUserApiImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      AuditUserApiImp a = new AuditUserApiImp.Builder<>().build();
    ...
    {
      AuditUserApiImp a = new AuditUserApiImp.Builder<>().build();
      AuditUserApiImp b = new AuditUserApiImp(a);
    ...
    {
      AuditUserApiImp a = new AuditUserApiImp.Builder<>().build();
      AuditUserApiImp b = new AuditUserApiImp.Builder<>().build();
        ...
        JsonMappingException
    {
      ...
      AuditUserApi b = mapper.readValue(s, AuditUserApi.class);
