...
@Test(groups = { "fast" })
public class ExportUserApiImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      ExportUserApiImp a = new ExportUserApiImp.Builder<>().build();
    ...
    {
      ExportUserApiImp a = new ExportUserApiImp.Builder<>().build();
      ExportUserApiImp b = new ExportUserApiImp(a);
    ...
    {
      ExportUserApiImp a = new ExportUserApiImp.Builder<>().build();
      ExportUserApiImp b = new ExportUserApiImp.Builder<>().build();
        ...
        JsonMappingException
    {
      ...
      ExportUserApi b = mapper.readValue(s, ExportUserApi.class);
