...
@Test(groups = { "fast" })
public class CustomFieldUserApiImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      CustomFieldUserApiImp a = new CustomFieldUserApiImp.Builder<>().build();
    ...
    {
      CustomFieldUserApiImp a = new CustomFieldUserApiImp.Builder<>().build();
      CustomFieldUserApiImp b = new CustomFieldUserApiImp(a);
    ...
    {
      CustomFieldUserApiImp a = new CustomFieldUserApiImp.Builder<>().build();
      CustomFieldUserApiImp b = new CustomFieldUserApiImp.Builder<>().build();
        ...
        JsonMappingException
    {
      ...
      CustomFieldUserApi b = mapper.readValue(s, CustomFieldUserApi.class);
