...
@Test(groups = { "fast" })
public class RecordIdApiImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      RecordIdApiImp a = new RecordIdApiImp.Builder<>().build();
    ...
    {
      RecordIdApiImp a = new RecordIdApiImp.Builder<>().build();
      RecordIdApiImp b = new RecordIdApiImp(a);
    ...
    {
      RecordIdApiImp a = new RecordIdApiImp.Builder<>().build();
      RecordIdApiImp b = new RecordIdApiImp.Builder<>().build();
        ...
        JsonMappingException
    {
      ...
      RecordIdApi b = mapper.readValue(s, RecordIdApi.class);
