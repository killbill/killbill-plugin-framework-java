...
@Test(groups = { "fast" })
public class ColumnInfoImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      ColumnInfoImp a = new ColumnInfoImp.Builder<>().build();
    ...
    {
      ColumnInfoImp a = new ColumnInfoImp.Builder<>().build();
      ColumnInfoImp b = new ColumnInfoImp(a);
    ...
    {
      ColumnInfoImp a = new ColumnInfoImp.Builder<>().build();
      ColumnInfoImp b = new ColumnInfoImp.Builder<>().build();
        ...
        JsonMappingException
    {
      ...
      ColumnInfo b = mapper.readValue(s, ColumnInfo.class);
