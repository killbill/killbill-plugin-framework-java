...
@Test(groups = { "fast" })
public class TenantContextImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      TenantContextImp a = new TenantContextImp.Builder<>().build();
    ...
    {
      TenantContextImp a = new TenantContextImp.Builder<>().build();
      TenantContextImp b = new TenantContextImp(a);
    ...
    {
      TenantContextImp a = new TenantContextImp.Builder<>().build();
      TenantContextImp b = new TenantContextImp.Builder<>().build();
        ...
        JsonMappingException
    {
      ...
      TenantContext b = mapper.readValue(s, TenantContext.class);
