...
@Test(groups = { "fast" })
public class CallContextImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      CallContextImp a = new CallContextImp.Builder<>().build();
    ...
    {
      CallContextImp a = new CallContextImp.Builder<>().build();
      CallContextImp b = new CallContextImp(a);
    ...
    {
      CallContextImp a = new CallContextImp.Builder<>().build();
      CallContextImp b = new CallContextImp.Builder<>().build();
        ...
        JsonMappingException
    {
      ...
      CallContext b = mapper.readValue(s, CallContext.class);
