...
@Test(groups = { "fast" })
public class ControlTagImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      ControlTagImp a = new ControlTagImp.Builder<>().build();
    ...
    {
      ControlTagImp a = new ControlTagImp.Builder<>().build();
      ControlTagImp b = new ControlTagImp(a);
    ...
    {
      ControlTagImp a = new ControlTagImp.Builder<>().build();
      ControlTagImp b = new ControlTagImp.Builder<>().build();
        ...
        JsonMappingException
    {
      ...
      ControlTag b = mapper.readValue(s, ControlTag.class);
