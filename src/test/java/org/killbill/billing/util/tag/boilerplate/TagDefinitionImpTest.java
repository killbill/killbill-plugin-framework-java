...
@Test(groups = { "fast" })
public class TagDefinitionImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      TagDefinitionImp a = new TagDefinitionImp.Builder<>().build();
    ...
    {
      TagDefinitionImp a = new TagDefinitionImp.Builder<>().build();
      TagDefinitionImp b = new TagDefinitionImp(a);
    ...
    {
      TagDefinitionImp a = new TagDefinitionImp.Builder<>().build();
      TagDefinitionImp b = new TagDefinitionImp.Builder<>().build();
        ...
        JsonMappingException
    {
      ...
      TagDefinition b = mapper.readValue(s, TagDefinition.class);
