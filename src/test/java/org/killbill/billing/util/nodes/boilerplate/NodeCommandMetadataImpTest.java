...
@Test(groups = { "fast" })
public class NodeCommandMetadataImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      NodeCommandMetadataImp a = new NodeCommandMetadataImp.Builder<>().build();
    ...
    {
      NodeCommandMetadataImp a = new NodeCommandMetadataImp.Builder<>().build();
      NodeCommandMetadataImp b = new NodeCommandMetadataImp(a);
    ...
    {
      NodeCommandMetadataImp a = new NodeCommandMetadataImp.Builder<>().build();
      NodeCommandMetadataImp b = new NodeCommandMetadataImp.Builder<>().build();
        ...
        JsonMappingException
    {
      ...
      NodeCommandMetadata b = mapper.readValue(s, NodeCommandMetadata.class);
