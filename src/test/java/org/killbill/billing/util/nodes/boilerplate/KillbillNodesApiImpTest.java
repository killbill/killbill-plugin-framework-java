...
@Test(groups = { "fast" })
public class KillbillNodesApiImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      KillbillNodesApiImp a = new KillbillNodesApiImp.Builder<>().build();
    ...
    {
      KillbillNodesApiImp a = new KillbillNodesApiImp.Builder<>().build();
      KillbillNodesApiImp b = new KillbillNodesApiImp(a);
    ...
    {
      KillbillNodesApiImp a = new KillbillNodesApiImp.Builder<>().build();
      KillbillNodesApiImp b = new KillbillNodesApiImp.Builder<>().build();
        ...
        JsonMappingException
    {
      ...
      KillbillNodesApi b = mapper.readValue(s, KillbillNodesApi.class);
