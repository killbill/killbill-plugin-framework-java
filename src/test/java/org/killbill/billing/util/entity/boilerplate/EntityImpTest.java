...
@Test(groups = { "fast" })
public class EntityImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      EntityImp a = new EntityImp.Builder<>().build();
    ...
    {
      EntityImp a = new EntityImp.Builder<>().build();
      EntityImp b = new EntityImp.Builder<>().build();
        ...
        JsonMappingException
    {
      ...
      Entity b = mapper.readValue(s, Entity.class);
