...
@Test(groups = { "fast" })
public class CustomFieldImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      CustomFieldImp a = new CustomFieldImp.Builder<>().build();
    ...
    {
      CustomFieldImp a = new CustomFieldImp.Builder<>().build();
      CustomFieldImp b = new CustomFieldImp(a);
    ...
    {
      CustomFieldImp a = new CustomFieldImp.Builder<>().build();
      CustomFieldImp b = new CustomFieldImp.Builder<>().build();
        ...
        JsonMappingException
    {
      ...
      CustomField b = mapper.readValue(s, CustomField.class);
