...
@Test(groups = { "fast" })
public class AccountAuditLogsForObjectTypeImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      AccountAuditLogsForObjectTypeImp a = new AccountAuditLogsForObjectTypeImp.Builder<>().build();
    ...
    {
      AccountAuditLogsForObjectTypeImp a = new AccountAuditLogsForObjectTypeImp.Builder<>().build();
      AccountAuditLogsForObjectTypeImp b = new AccountAuditLogsForObjectTypeImp(a);
    ...
    {
      AccountAuditLogsForObjectTypeImp a = new AccountAuditLogsForObjectTypeImp.Builder<>().build();
      AccountAuditLogsForObjectTypeImp b = new AccountAuditLogsForObjectTypeImp.Builder<>().build();
        ...
        JsonMappingException
    {
      ...
      AccountAuditLogsForObjectType b = mapper.readValue(s, AccountAuditLogsForObjectType.class);
