...
@Test(groups = { "fast" })
public class PluginsInfoApiImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      PluginsInfoApiImp a = new PluginsInfoApiImp.Builder<>().build();
    ...
    {
      PluginsInfoApiImp a = new PluginsInfoApiImp.Builder<>().build();
      PluginsInfoApiImp b = new PluginsInfoApiImp(a);
    ...
    {
      PluginsInfoApiImp a = new PluginsInfoApiImp.Builder<>().build();
      PluginsInfoApiImp b = new PluginsInfoApiImp.Builder<>().build();
        ...
        JsonMappingException
    {
      ...
      PluginsInfoApi b = mapper.readValue(s, PluginsInfoApi.class);
