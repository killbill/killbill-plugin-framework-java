...
@Test(groups = { "fast" })
public class OSGIPluginPropertiesImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      OSGIPluginPropertiesImp a = new OSGIPluginPropertiesImp.Builder<>().build();
    ...
    {
      OSGIPluginPropertiesImp a = new OSGIPluginPropertiesImp.Builder<>().build();
      OSGIPluginPropertiesImp b = new OSGIPluginPropertiesImp(a);
    ...
    {
      OSGIPluginPropertiesImp a = new OSGIPluginPropertiesImp.Builder<>().build();
      OSGIPluginPropertiesImp b = new OSGIPluginPropertiesImp.Builder<>().build();
        ...
        JsonMappingException
    {
      ...
      OSGIPluginProperties b = mapper.readValue(s, OSGIPluginProperties.class);
