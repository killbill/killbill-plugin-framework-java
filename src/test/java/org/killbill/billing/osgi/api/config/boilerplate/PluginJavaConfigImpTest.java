...
@Test(groups = { "fast" })
public class PluginJavaConfigImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      PluginJavaConfigImp a = new PluginJavaConfigImp.Builder<>().build();
    ...
    {
      PluginJavaConfigImp a = new PluginJavaConfigImp.Builder<>().build();
      PluginJavaConfigImp b = new PluginJavaConfigImp(a);
    ...
    {
      PluginJavaConfigImp a = new PluginJavaConfigImp.Builder<>().build();
      PluginJavaConfigImp b = new PluginJavaConfigImp.Builder<>().build();
        ...
        JsonMappingException
    {
      ...
      PluginJavaConfig b = mapper.readValue(s, PluginJavaConfig.class);
