...
@Test(groups = { "fast" })
public class PluginServiceInfoImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      PluginServiceInfoImp a = new PluginServiceInfoImp.Builder<>().build();
    ...
    {
      PluginServiceInfoImp a = new PluginServiceInfoImp.Builder<>().build();
      PluginServiceInfoImp b = new PluginServiceInfoImp(a);
    ...
    {
      PluginServiceInfoImp a = new PluginServiceInfoImp.Builder<>().build();
      PluginServiceInfoImp b = new PluginServiceInfoImp.Builder<>().build();
    ...
    public void callGetters()
    {
      ...
      a.getRegistrationName();
      a.getServiceTypeName();
    }
    @Test
        ...
        JsonMappingException
    {
      ...
      PluginServiceInfo b = mapper.readValue(s, PluginServiceInfo.class);
