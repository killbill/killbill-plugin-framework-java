...
public class HealthcheckImpTest {
    ...
    {
      HealthcheckImp a = new HealthcheckImp.Builder<>().build();
    ...
    {
      HealthcheckImp a = new HealthcheckImp.Builder<>().build();
      HealthcheckImp b = new HealthcheckImp(a);
    ...
    {
      HealthcheckImp a = new HealthcheckImp.Builder<>().build();
      HealthcheckImp b = new HealthcheckImp.Builder<>().build();
        ...
        JsonMappingException
    {
      ...
      Healthcheck b = mapper.readValue(s, Healthcheck.class);
