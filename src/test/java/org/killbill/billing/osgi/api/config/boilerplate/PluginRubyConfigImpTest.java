...
@Test(groups = { "fast" })
public class PluginRubyConfigImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      PluginRubyConfigImp a = new PluginRubyConfigImp.Builder<>().build();
    ...
    {
      PluginRubyConfigImp a = new PluginRubyConfigImp.Builder<>().build();
      PluginRubyConfigImp b = new PluginRubyConfigImp(a);
    ...
    {
      PluginRubyConfigImp a = new PluginRubyConfigImp.Builder<>().build();
      PluginRubyConfigImp b = new PluginRubyConfigImp.Builder<>().build();
        ...
        JsonMappingException
    {
      ...
      PluginRubyConfig b = mapper.readValue(s, PluginRubyConfig.class);
