...
@Test(groups = { "fast" })
public class PluginInfoImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      PluginInfoImp a = new PluginInfoImp.Builder<>().build();
    ...
    {
      PluginInfoImp a = new PluginInfoImp.Builder<>().build();
      PluginInfoImp b = new PluginInfoImp(a);
    ...
    {
      PluginInfoImp a = new PluginInfoImp.Builder<>().build();
      PluginInfoImp b = new PluginInfoImp.Builder<>().build();
        ...
        JsonMappingException
    {
      ...
      PluginInfo b = mapper.readValue(s, PluginInfo.class);
