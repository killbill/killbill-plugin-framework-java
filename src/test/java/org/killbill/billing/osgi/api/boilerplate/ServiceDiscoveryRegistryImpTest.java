...
@Test(groups = { "fast" })
public class ServiceDiscoveryRegistryImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      ServiceDiscoveryRegistryImp a = new ServiceDiscoveryRegistryImp.Builder<>().build();
    ...
    {
      ServiceDiscoveryRegistryImp a = new ServiceDiscoveryRegistryImp.Builder<>().build();
      ServiceDiscoveryRegistryImp b = new ServiceDiscoveryRegistryImp(a);
    ...
    {
      ServiceDiscoveryRegistryImp a = new ServiceDiscoveryRegistryImp.Builder<>().build();
      ServiceDiscoveryRegistryImp b = new ServiceDiscoveryRegistryImp.Builder<>().build();
        ...
        JsonMappingException
    {
      ...
      ServiceDiscoveryRegistry b = mapper.readValue(s, ServiceDiscoveryRegistry.class);
