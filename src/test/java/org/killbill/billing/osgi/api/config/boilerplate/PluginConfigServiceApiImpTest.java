...
@Test(groups = { "fast" })
public class PluginConfigServiceApiImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      PluginConfigServiceApiImp a = new PluginConfigServiceApiImp.Builder<>().build();
    ...
    {
      PluginConfigServiceApiImp a = new PluginConfigServiceApiImp.Builder<>().build();
      PluginConfigServiceApiImp b = new PluginConfigServiceApiImp(a);
    ...
    {
      PluginConfigServiceApiImp a = new PluginConfigServiceApiImp.Builder<>().build();
      PluginConfigServiceApiImp b = new PluginConfigServiceApiImp.Builder<>().build();
        ...
        JsonMappingException
    {
      ...
      PluginConfigServiceApi b = mapper.readValue(s, PluginConfigServiceApi.class);
