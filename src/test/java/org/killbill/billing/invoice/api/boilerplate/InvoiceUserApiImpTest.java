...
@Test(groups = { "fast" })
public class InvoiceUserApiImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      InvoiceUserApiImp a = new InvoiceUserApiImp.Builder<>().build();
    ...
    {
      InvoiceUserApiImp a = new InvoiceUserApiImp.Builder<>().build();
      InvoiceUserApiImp b = new InvoiceUserApiImp(a);
    ...
    {
      InvoiceUserApiImp a = new InvoiceUserApiImp.Builder<>().build();
      InvoiceUserApiImp b = new InvoiceUserApiImp.Builder<>().build();
        ...
        JsonMappingException
    {
      ...
      InvoiceUserApi b = mapper.readValue(s, InvoiceUserApi.class);
