...
@Test(groups = { "fast" })
public class InvoiceCreationEventImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      InvoiceCreationEventImp a = new InvoiceCreationEventImp.Builder<>().build();
    ...
    {
      InvoiceCreationEventImp a = new InvoiceCreationEventImp.Builder<>().build();
      InvoiceCreationEventImp b = new InvoiceCreationEventImp(a);
    ...
    {
      InvoiceCreationEventImp a = new InvoiceCreationEventImp.Builder<>().build();
      InvoiceCreationEventImp b = new InvoiceCreationEventImp.Builder<>().build();
        ...
        JsonMappingException
    {
      ...
      InvoiceCreationEvent b = mapper.readValue(s, InvoiceCreationEvent.class);
