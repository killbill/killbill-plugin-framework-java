...
@Test(groups = { "fast" })
public class InvoiceGroupImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      InvoiceGroupImp a = new InvoiceGroupImp.Builder<>().build();
    ...
    {
      InvoiceGroupImp a = new InvoiceGroupImp.Builder<>().build();
      InvoiceGroupImp b = new InvoiceGroupImp(a);
    ...
    {
      InvoiceGroupImp a = new InvoiceGroupImp.Builder<>().build();
      InvoiceGroupImp b = new InvoiceGroupImp.Builder<>().build();
        ...
        JsonMappingException
    {
      ...
      InvoiceGroup b = mapper.readValue(s, InvoiceGroup.class);
