...
@Test(groups = { "fast" })
public class AdditionalItemsResultImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      AdditionalItemsResultImp a = new AdditionalItemsResultImp.Builder<>().build();
    ...
    {
      AdditionalItemsResultImp a = new AdditionalItemsResultImp.Builder<>().build();
      AdditionalItemsResultImp b = new AdditionalItemsResultImp(a);
    ...
    {
      AdditionalItemsResultImp a = new AdditionalItemsResultImp.Builder<>().build();
      AdditionalItemsResultImp b = new AdditionalItemsResultImp.Builder<>().build();
        ...
        JsonMappingException
    {
      ...
      AdditionalItemsResult b = mapper.readValue(s, AdditionalItemsResult.class);
