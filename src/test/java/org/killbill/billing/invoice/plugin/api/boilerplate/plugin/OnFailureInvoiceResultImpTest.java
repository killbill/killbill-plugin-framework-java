...
@Test(groups = { "fast" })
public class OnFailureInvoiceResultImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      OnFailureInvoiceResultImp a = new OnFailureInvoiceResultImp.Builder<>().build();
    ...
    {
      OnFailureInvoiceResultImp a = new OnFailureInvoiceResultImp.Builder<>().build();
      OnFailureInvoiceResultImp b = new OnFailureInvoiceResultImp(a);
    ...
    {
      OnFailureInvoiceResultImp a = new OnFailureInvoiceResultImp.Builder<>().build();
      OnFailureInvoiceResultImp b = new OnFailureInvoiceResultImp.Builder<>().build();
        ...
        JsonMappingException
    {
      ...
      OnFailureInvoiceResult b = mapper.readValue(s, OnFailureInvoiceResult.class);
