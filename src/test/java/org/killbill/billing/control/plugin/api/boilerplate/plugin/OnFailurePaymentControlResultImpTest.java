...
@Test(groups = { "fast" })
public class OnFailurePaymentControlResultImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      OnFailurePaymentControlResultImp a = new OnFailurePaymentControlResultImp.Builder<>().build();
    ...
    {
      OnFailurePaymentControlResultImp a = new OnFailurePaymentControlResultImp.Builder<>().build();
      OnFailurePaymentControlResultImp b = new OnFailurePaymentControlResultImp(a);
    ...
    {
      OnFailurePaymentControlResultImp a = new OnFailurePaymentControlResultImp.Builder<>().build();
      OnFailurePaymentControlResultImp b = new OnFailurePaymentControlResultImp.Builder<>().build();
        ...
        JsonMappingException
    {
      ...
      OnFailurePaymentControlResult b = mapper.readValue(s, OnFailurePaymentControlResult.class);
