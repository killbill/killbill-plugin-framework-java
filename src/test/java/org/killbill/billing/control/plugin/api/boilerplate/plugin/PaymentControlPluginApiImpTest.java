...
@Test(groups = { "fast" })
public class PaymentControlPluginApiImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      PaymentControlPluginApiImp a = new PaymentControlPluginApiImp.Builder<>().build();
    ...
    {
      PaymentControlPluginApiImp a = new PaymentControlPluginApiImp.Builder<>().build();
      PaymentControlPluginApiImp b = new PaymentControlPluginApiImp(a);
    ...
    {
      PaymentControlPluginApiImp a = new PaymentControlPluginApiImp.Builder<>().build();
      PaymentControlPluginApiImp b = new PaymentControlPluginApiImp.Builder<>().build();
        ...
        JsonMappingException
    {
      ...
      PaymentControlPluginApi b = mapper.readValue(s, PaymentControlPluginApi.class);
