...
@Test(groups = { "fast" })
public class ControlResultImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      ControlResultImp a = new ControlResultImp.Builder<>().build();
    ...
    {
      ControlResultImp a = new ControlResultImp.Builder<>().build();
      ControlResultImp b = new ControlResultImp(a);
    ...
    {
      ControlResultImp a = new ControlResultImp.Builder<>().build();
      ControlResultImp b = new ControlResultImp.Builder<>().build();
        ...
        JsonMappingException
    {
      ...
      ControlResult b = mapper.readValue(s, ControlResult.class);
