...
@Test(groups = { "fast" })
public class OverdueStatesAccountImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      OverdueStatesAccountImp a = new OverdueStatesAccountImp.Builder<>().build();
    ...
    {
      OverdueStatesAccountImp a = new OverdueStatesAccountImp.Builder<>().build();
      OverdueStatesAccountImp b = new OverdueStatesAccountImp(a);
    ...
    {
      OverdueStatesAccountImp a = new OverdueStatesAccountImp.Builder<>().build();
      OverdueStatesAccountImp b = new OverdueStatesAccountImp.Builder<>().build();
    ...
    public void callGetters()
    {
      ...
      a.getInitialReevaluationInterval();
      a.getStates();
    }
    @Test
        ...
        JsonMappingException
    {
      ...
      OverdueStatesAccount b = mapper.readValue(s, OverdueStatesAccount.class);
