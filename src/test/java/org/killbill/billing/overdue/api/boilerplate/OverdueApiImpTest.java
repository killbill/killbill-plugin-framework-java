...
@Test(groups = { "fast" })
public class OverdueApiImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      OverdueApiImp a = new OverdueApiImp.Builder<>().build();
    ...
    {
      OverdueApiImp a = new OverdueApiImp.Builder<>().build();
      OverdueApiImp b = new OverdueApiImp(a);
    ...
    {
      OverdueApiImp a = new OverdueApiImp.Builder<>().build();
      OverdueApiImp b = new OverdueApiImp.Builder<>().build();
        ...
        JsonMappingException
    {
      ...
      OverdueApi b = mapper.readValue(s, OverdueApi.class);
