...
@Test(groups = { "fast" })
public class KillbillApiImpTest {
    @Test
    public void anInstanceShouldBeEqualToItself()
    {
      KillbillApiImp a = new KillbillApiImp.Builder<>().build();
    ...
    {
      KillbillApiImp a = new KillbillApiImp.Builder<>().build();
      KillbillApiImp b = new KillbillApiImp(a);
    ...
    {
      KillbillApiImp a = new KillbillApiImp.Builder<>().build();
      KillbillApiImp b = new KillbillApiImp.Builder<>().build();
        ...
        JsonMappingException
    {
      ...
      KillbillApi b = mapper.readValue(s, KillbillApi.class);
