...
public class SubscriptionApiImp implements SubscriptionApi {
    ...
    public Subscription getSubscriptionForEntitlementId(final UUID entitlementId, final boolean includeDeletedEvents, final TenantContext context) {
        throw new UnsupportedOperationException("getSubscriptionForEntitlementId(java.util.UUID, boolean, org.killbill.billing.util.callcontext.TenantContext) must be implemented.");
    }
    @Override
    ...
    @Override
    public Pagination<SubscriptionBundle> getSubscriptionBundlesForAccountId(final UUID accountId, final Long offset, final Long limit, final TenantContext context) {
