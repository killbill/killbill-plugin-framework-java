...
public class Resolver extends SimpleAbstractTypeResolver {
    public Resolver(){
        this.addMapping(EntitlementContext.class, EntitlementContextImp.class);
        this.addMapping(EntitlementPluginApi.class, EntitlementPluginApiImp.class);
        this.addMapping(OnFailureEntitlementResult.class, OnFailureEntitlementResultImp.class);
        this.addMapping(OnSuccessEntitlementResult.class, OnSuccessEntitlementResultImp.class);
        this.addMapping(PriorEntitlementResult.class, PriorEntitlementResultImp.class);
    }
}
